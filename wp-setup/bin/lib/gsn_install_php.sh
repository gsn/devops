...
function gsn_install_php()
{
	...
	apt-get -y --force-yes install php5-common php5-mysqlnd php5-xmlrpc php5-mysql \
    ...
    php5-sqlite php5-tidy php5-xsl \
    php5-memcache php5-geoip 2>&1 || gsn_lib_error "Unable to install PHP5, exit status = " $?
}
